class Sorter:
    ...
    def sort_strings(self, iterable):
        ...
        input_string = input("")
        # here we inputted the stings
        strlist= input_string.split(" ")
        #here we ttok the input and seperated them with a space
        words = strlist.split()
        #here we split words with space being the end for each word
        words.sort()
        #here we sorted using the funtion
